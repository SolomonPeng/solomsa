...
public class TypeCaseUtils {
    ...
    public static Object convert(Object obj, String type, String format)
        ...
        if (obj instanceof String) {
            ...
            if ("Double".equalsIgnoreCase(type) || "java.lang.Double".equals(type)) {
            	Locale locale = new Locale("zh", "CN", "");
                Number tempNum = getNf(locale).parse(str);
                return new Double(tempNum.doubleValue());
            }                
            if ("Float".equalsIgnoreCase(type) || "java.lang.Float".equals(type)) {
            	Locale locale = new Locale("zh", "CN", "");
                Number tempNum = getNf(locale).parse(str);
            ...
            if ("int".equalsIgnoreCase(type) || "Integer".equals(type) || "java.lang.Integer".equals(type)) {
            	Locale locale = new Locale("zh", "CN", "");
                NumberFormat nf = getNf(locale);
                nf.setMaximumFractionDigits(0);
                Number tempNum = nf.parse(str);
                ...
                if (format == null || format.length() == 0)
                    try {
                    	if(str.indexOf("\\.")>0||str.indexOf("-")>0) {
                    		return DateUtils.strToDate(str.replaceAll("\\.", "-"),
            ...
            if ("Timestamp".equals(type) || "java.sql.Timestamp".equals(type)) {
                ...
                throw new ParseException("Conversion from " + fromType
                        + " to " + type + " not currently supported",0);
            }
        }
        ...
        if (obj instanceof Long) {
            ...
            if ("Timestamp".equals(type) || "java.sql.Timestamp".equals(type))
            	return new Timestamp((new Date(lng.longValue())).getTime());
            else
                throw new ParseException("Conversion from " + fromType
                        + " to " + type + " not currently supported",0);
        }
        ...
        if (obj instanceof BigInteger) {
            fromType = "Integer";
            BigInteger intgr = (BigInteger) obj;
            Locale locale = new Locale("zh", "CN", "");
            if ("String".equals(type) || "java.lang.String".equals(type))
                return getNf(locale).format(intgr.longValue());
            if ("Double".equalsIgnoreCase(type) || "java.lang.Double".equals(type))
            ...
            if ("Long".equalsIgnoreCase(type) || "java.lang.Long".equals(type))
                return new Long(intgr.longValue());
            if ("int".equalsIgnoreCase(type) || "Integer".equalsIgnoreCase(type) || "java.lang.Integer".equals(type))
        ...
        if ("String".equals(type) || "java.lang.String".equals(type))
            ...
            throw new ParseException("Conversion from "
    ...
    public static Boolean convert2SBoolean(Object obj) throws ParseException {
        return (Boolean) convert(obj, "Boolean", null);
    }

    public static Integer convert2Integer(Object obj) throws ParseException {
        return (Integer) convert(obj, "Integer", null);
    }

    public static String convert2String(Object obj) throws ParseException {
        return (String) convert(obj, "String", null);
    }

    public static String convert2String2(Object obj) throws ParseException {
        return (String) convert(obj, "String", DateUtils.fullFormat);
    }
    ...
    public static Long convert2Long(Object obj) throws ParseException {
        return (Long) convert(obj, "Long", null);
    }

    public static Double convert2Double(Object obj) throws ParseException {
