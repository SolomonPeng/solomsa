package com.accenture.microservice.redis.cache;
...
import com.accenture.microservice.redis.lock.RedisLock;
import com.accenture.microservice.redis.utils.ThreadTaskUtils;
...
public class CustomizedRedisCache extends RedisCache {
    ...
    /*private CacheSupport getCacheSupport() {
        return AppContext.getBean(CacheSupport.class);
    }*/
    ...
    public CustomizedRedisCache(String name, byte[] prefix, RedisOperations<String,Object> redisOperations, long expiration, long preloadSecondTime) {
    ...
    public CustomizedRedisCache(String name, byte[] prefix, RedisOperations<String,Object> redisOperations, long expiration, long preloadSecondTime, boolean allowNullValues) {
    ...
    public RedisCacheElement get(final RedisCacheKey cacheKey) {
        ...
        Boolean exists = (Boolean) redisOperations.execute(callback);
                ...
                public void run() {
                    ...
                    try {
                        if (redisLock.lock()) {
                            ...
                            if (null != ttl && ttl <= preloadSecondTime) {
                                // 通过获取代理方法信息重新加载缓存数据
                            	cacheSupport.refreshCacheByKey(getName(), cacheKeyStr);
                            }
                        }
                    } catch (Exception e) {
